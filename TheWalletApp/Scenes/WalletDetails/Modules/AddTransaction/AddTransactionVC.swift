...
class AddTransactionVC: UIViewController, UITextFieldDelegate {
    ...
    var presenter: AddTransactionViewPresenterProtocol!
    ...
    @objc func buttonAction(){
        presenter.saveTransaction(transactionType: inputType.text ?? "", transactionAmount: inputChange.text ?? "", transactionNote: inputNote.text ?? "", buttonState: buttonIncome.state)
    ...
    override func viewDidLoad() {
        ...
        setLabels(label: addTransactionLabel, text: "Add transaction")
        setLabels(label: labelType, text: "Title")
        setLabels(label: labelChange, text: "Change")
        setLabels(label: labelNote, text: "Note")
        
        setTextFields(gni: inputType, placeholder: "Start here...")
        setTextFields(gni: inputChange, placeholder: "Type here...")
        setTextFields(gni: inputNote, placeholder: "Start here...")
    ...
    func setTextFields(gni:UITextField, placeholder: String){
        gni.attributedPlaceholder = NSAttributedString(string: placeholder,
...
extension AddTransactionVC: AddTransactionViewProtocol {
